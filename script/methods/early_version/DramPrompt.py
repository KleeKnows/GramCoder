...
# Task2: Identify the algorithm needed to solve the original problem
...
2. Generate example {self.language} code step by step to solve that problem, if the code is too long, output a short pseudocode to describe the code;
3. Generate a plan to solve that problem;
4. Provide a solution strategy for solving the original problem;
5. Based on the selected algorithm and the solution, provide a confidence score.
...
<example_code>Generate example {self.language} code step by step to solve that problem, if the code is too long, output a short pseudocode to describe the code.</example_code>
...
<confidence>Provide a **integer** type confidence score (0-100) indicating how confident you are that this algorithm and solution strategy will solve the problem correctly. Do not generate extra words.</confidence>
</problem>
...
(2) Consider various solution strategyes
...
2. Take the failed sample in test_log as examples, and verify the correctness of the solution.

# Task3: Based on analysis, recall {num_mapping[self.n]} equivalent problems with detailed descriptions (different from original problem mentioned above), then propose solution strategies for original problem prioritizing correctness. For each problem,
1. Describe the problem in detail;
2. Generate example {self.language} code step by step to solve that problem, if the code is too long, output a short pseudocode to describe the code;
3. Generate a plan to solve that problem;
4. Identify the algorithm and provide a new solution strategy;
5. Based on the selected algorithm and the solution, provide a confidence score (0-100).
...
<root>
<analysis>
Identify the algorithm needed to solve the original problem again:
...
<problem>
# Rethink the original problem, understand the requirements and recall {num_mapping[self.n]} equivalent problems with detailed descriptions (different from original problem mentioned above). For each problem,
<example_description>Describe the problem.</example_description>
<example_code>Generate code step by step to solve this problem. If the code is too long, output a short pseudocode to describe the code.</example_code>
<example_plan>Generate a plan to solve this problem.</example_plan>
<solution>Provide a high level generic solution strategy for solving the original problem using the selected algorithm, including the data structure and main tasks. Do not generate code.</solution>
<confidence>Provide a confidence score (0-100) indicating how confident you are that this algorithm and solution strategy will solve the problem correctly. Do not generate extra words.</confidence>
</problem>
...
1. If the code does not follow the plan, improve the code to solve the problem correctly.

2. If the code follows the plan, recheck the original plan: 
